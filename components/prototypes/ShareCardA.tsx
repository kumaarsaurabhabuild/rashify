...
/* PROTOTYPE A — Spotify-Wrapped style.
   Bold gradient. Massive archetype name. Quotable viral line in white box.
   Element-driven palette: fire / earth / air / water from lagna sign. */
...
export function ShareCardA({ archetype: a }: { archetype: Archetype }) {
    ...
    >
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 24, zIndex: 1 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
          <span style={{
            fontSize: 52, color: palette.accent, display: 'flex',
          }}>{palette.glyph}</span>
          <span style={{
      ...
      {/* Mid — quotable line in white block */}
      <div style={{
        background: '#ffffff',
        color: '#1a1a1a',
        padding: '56px 64px',
